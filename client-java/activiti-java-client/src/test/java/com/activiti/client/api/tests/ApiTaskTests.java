...
public class ApiTaskTests extends ActivitiAPITestCase
{
    ...
    public void standAloneLifeCycle() throws IOException
    {
        ...
        Assert.assertFalse(taskRep.isInitiatorCanCompleteTask(), "Response has No Priority");
        ...
        // ATTACH DOCUMENT
        File file = getResourceFile("/com/activiti/client/api/tests/test.txt");
        ...
        Assert.assertTrue(taskCompleted.isInitiatorCanCompleteTask(), "Response has No Priority");
