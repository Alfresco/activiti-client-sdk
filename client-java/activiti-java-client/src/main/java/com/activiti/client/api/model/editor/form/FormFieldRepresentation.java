...
public class FormFieldRepresentation
{
    ...
    public boolean isFieldTypeText()
    {
        return FormFieldTypes.BOOLEAN.equals(type) || FormFieldTypes.SINGLE_LINE_TEXT.equals(type)
                ...
                || FormFieldTypes.AMOUNT.equals(type) || FormFieldTypes.DROPDOWN.equals(type) || FormFieldTypes.RADIO_BUTTONS.equals(type);
    }
    ...
    {
        return FormFieldTypes.TYPEAHEAD.equals(type);
    }
